...
public class AddFood extends JFrame implements ActionListener{
    ...
    public AddFood() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("HMS/Images/Burger.jpg"));
        ...
        comboBox = new JComboBox(new String[] { "VEG", "CHICEKN","MUTTON","ALL" });
        ...
        try{
            ...
            if(ae.getSource() == b1){
                try{
                    ...
                    String str = "INSERT INTO addfood values( '"+name+"', '"+type+"', '"+available+"','"+materials+"', '"+size+"', '"+price+"')";
