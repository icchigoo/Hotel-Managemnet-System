...
public class Reception3 extends JFrame implements ActionListener{
    ...
    Reception3(){
        ...
        JLabel l10 = new JLabel("Cooperate Page");
    ...
    public void actionPerformed(ActionEvent ae){
       ...
       new Managerinfo3().setVisible(true);
        this.setVisible(false);
